...
const proprietaireRoutes = [
	...
	<Route path='/proprietaires/edit/:id' component={Update} exact key='update' />,
	...
	<Route path='/proprietaires/:page' component={List} exact strict key='page' />,
];

export default proprietaireRoutes;
